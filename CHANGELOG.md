...
- Situazione documenti: nella barra in alto ci sono due nuovi controlli. **Stato ultima revisione** filtra i documenti in base a come sta l'ultima revisione, a spunte multiple: ci sono le risposte del cliente in uso più *Inviato al Cliente* e *Da inviare*, così si includono o si escludono in un colpo solo i documenti in attesa di risposta e quelli mai inviati; ogni voce porta il quadratino del colore che si vede nella colonna B&R Doc. **Solo ultima revisione** (vista verticale) riduce la tabella a una riga per documento, quella dell'ultima revisione
- Situazione documenti: con un filtro attivo l'export Excel e PDF contiene solo i documenti rimasti a schermo e, con *Solo ultima revisione* acceso, solo quella revisione. Vale per entrambe le viste e per tutti i filtri, anche quelli di colonna già esistenti
