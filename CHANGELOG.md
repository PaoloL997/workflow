...
- Situazione documenti, vista orizzontale: se l'ultima revisione è stata inviata al cliente e non ha ancora una risposta, la cella **B&R Doc** prende il giallo dell'*Inviato al Cliente* invece del colore dell'ultima risposta ricevuta, così si distingue a colpo d'occhio cosa è in attesa da cosa è già stato valutato. La voce è stata aggiunta alla legenda sotto la tabella e la stessa regola vale per l'export Excel e per il PDF della vista orizzontale
