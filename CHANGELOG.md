...
- Situazione documenti: nella barra in alto ci sono due nuovi controlli. **Filtra per risposta del cliente** filtra i documenti in base a come sta l'ultima revisione, a spunte multiple: ci sono le risposte del cliente in uso più *Inviato al Cliente* e *Da inviare*, così si includono o si escludono in un colpo solo i documenti in attesa di risposta e quelli mai inviati; ogni voce porta il quadratino del colore che si vede nella colonna B&R Doc. Nella vista verticale, dove una riga è una revisione, con questo filtro acceso resta la sola riga dell'ultima revisione dei documenti trovati: il filtro parla di quella, mostrare anche le precedenti (con risposte diverse da quelle spuntate) direbbe una cosa per un'altra. **Mostra solo ultima revisione** fa la stessa riduzione senza filtrare niente
