...
from . import views
from .forms import WorkflowPasswordResetForm
...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            ...
            form_class=WorkflowPasswordResetForm,
    ...
    path(
        ...
        views.commessa_anomalie_api,
        name="commessa_anomalie_api",
    ),
    path(
        "api/commesse/<str:job>/anomalie/risolvi/",
        views.commessa_anomalie_risolvi_api,
        name="commessa_anomalie_risolvi_api",
    ),
    path(
        "api/commesse/<str:job>/anomalie/ignora/",
    ...
    path(
        "api/commesse/<str:job>/quality-control-plan/",
        views.quality_control_plan_api,
        name="quality_control_plan_api",
    ),
    path(
        "api/commesse/<str:job>/quality-control-plan/prefill/",
