...
# Colori degli stati interni che la cella B&R Doc mostra quando non c'è ancora
# una risposta del cliente sull'ultima revisione (vedi situazione_cella_vendor).
# Giallo per la revisione partita e in attesa di risposta, grigio per quella
# ancora da inviare. Uguali a schermo, in Excel e nel PDF.
INVIATO_BG = "#F4C325"
DA_INVIARE_BG = "#B8BFCC"
...
def da_inviare_cell_colors() -> dict:
    """``{"bg", "fg"}`` della cella «da inviare»."""
    return cell_colors(DA_INVIARE_BG)
