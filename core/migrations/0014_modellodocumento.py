    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_title', models.CharField(db_column='DocTitle', max_length=300, verbose_name='Titolo documento')),
                ('item_no', models.CharField(blank=True, db_column='ItemNo', default='', max_length=100, verbose_name='Item')),
                ('codice_fisso', models.CharField(
                    db_column='CodiceFisso', max_length=100, verbose_name='Codice fisso',
